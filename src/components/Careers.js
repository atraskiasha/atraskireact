        ...
        <div class="col-xl-3 col-sm-6 mb-5">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="https://bootstrapious.com/i/snippets/sn-team/teacher-4.jpg" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
                ...
                <ul class="social mb-0 list-inline mt-3">
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="fa-brands fa-square-facebook"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="fa-brands fa-square-twitter"></i></a></li>
                    <li class="list-inline-item"><a href="#" class="social-link"><i class="fa-brands fa-square-instagram"></i></a></li>
    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-4">
          <div className="card">
            <div className="card-body">
              <h5 className="card-title" style={{color:'black'}}>Position 1</h5>
              <p className="card-text"style={{color:'black'}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed dapibus odio nec arcu consequat, et maximus ligula venenatis.</p>
        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-body">
              <h5 className="card-title" style={{color:'black'}}>Position 2</h5>
              <p className="card-text"style={{color:'black'}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed dapibus odio nec arcu consequat, et maximus ligula venenatis.</p>
              <a href="#" className="btn btn-primary">Apply Now</a>
            </div>
          </div>
        ...
        <div className="col-md-4">
          <div className="card">
            <div className="card-body">
              <h5 className="card-title" style={{color:'black'}}>Position 3</h5>
              <p className="card-text"style={{color:'black'}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed dapibus odio nec arcu consequat, et maximus ligula venenatis.</p>
              <a href="#" className="btn btn-primary">Apply Now</a>
            </div>
          </div>
